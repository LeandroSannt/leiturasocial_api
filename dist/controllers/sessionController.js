...
var AuthenticatedService_1 = __importDefault(require("../services/users/AuthenticatedService"));
var SessionController = /** @class */ (function () {
    function SessionController() {
    }
    SessionController.prototype.postUser = function (request, response) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        authenticateUser = new AuthenticatedService_1.default();
