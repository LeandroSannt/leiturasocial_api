...
var Books_1 = __importDefault(require("../entities/Books"));
var BooksRepository = /** @class */ (function (_super) {
    __extends(BooksRepository, _super);
    function BooksRepository() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    BooksRepository.prototype.getBooksCategory = function (category_id, name_title) {
                    ...
                    case 0:
                        ...
                        if (category_id && name_title) {
                            where = {
                                ...
                                title: (0, typeorm_1.ILike)("%".concat(name_title, "%"))
                            };
                        }
                        if (!category_id && name_title) {
                            where = {
    ...
    BooksRepository = __decorate([
        (0, typeorm_1.EntityRepository)(Books_1.default)
    ], BooksRepository);
